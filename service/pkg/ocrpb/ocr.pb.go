...
const file_ocr_proto_rawDesc = "" +
	"\n" +
	"\tocr.proto\x12\x03ocr\"\xa0\x01\n" +
	"\tClientMsg\x12\"\n" +
	"\x05start\x18\x01 \x01(\v2\n" +
	".ocr.StartH\x00R\x05start\x12%\n" +
	"\x05chunk\x18\x02 \x01(\v2\r.ocr.PdfChunkH\x00R\x05chunk\x12\x1c\n" +
	"\x03end\x18\x03 \x01(\v2\b.ocr.EndH\x00R\x03end\x12\x1f\n" +
	"\x04ping\x18\x04 \x01(\v2\t.ocr.PingH\x00R\x04pingB\t\n" +
	"\apayload\"\xd3\x01\n" +
	"\tServerMsg\x12\"\n" +
	"\x05ready\x18\x01 \x01(\v2\n" +
	".ocr.ReadyH\x00R\x05ready\x12\x1f\n" +
	"\x04pong\x18\x02 \x01(\v2\t.ocr.PongH\x00R\x04pong\x12+\n" +
	"\bprogress\x18\x03 \x01(\v2\r.ocr.ProgressH\x00R\bprogress\x12%\n" +
	"\x06result\x18\x04 \x01(\v2\v.ocr.ResultH\x00R\x06result\x12\"\n" +
	"\x05error\x18\x05 \x01(\v2\n" +
	".ocr.ErrorH\x00R\x05errorB\t\n" +
	"\apayload\"w\n" +
	"\x05Start\x12\x1d\n" +
	"\n" +
	...
	"\x03dpi\x18\x04 \x01(\x05R\x03dpi\"\x1e\n" +
	"\bPdfChunk\x12\x12\n" +
	...
	"\n" +
	"pages_done\x18\x02 \x01(\x05R\tpagesDone\"\xc9\x01\n" +
	"\x06Result\x12\x1d\n" +
	"\n" +
	...
	"\tlanguages\x18\x06 \x03(\tR\tlanguages\x12\x12\n" +
	"\x04text\x18\a \x01(\tR\x04text\x12\x1a\n" +
	"\bfilename\x18\b \x01(\tR\bfilename\"!\n" +
	"\x05Error\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2C\n" +
	"\n" +
	"OcrService\x125\n" +
	"\x0fExtractTextBidi\x12\x0e.ocr.ClientMsg\x1a\x0e.ocr.ServerMsg(\x010\x01B;Z9github.com/m11ano/neurochar-experiments-3/pkg/ocrpb;ocrpbb\x06proto3"
...
var file_ocr_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_ocr_proto_goTypes = []any{
	(*ClientMsg)(nil), // 0: ocr.ClientMsg
	(*ServerMsg)(nil), // 1: ocr.ServerMsg
	(*Start)(nil),     // 2: ocr.Start
	(*PdfChunk)(nil),  // 3: ocr.PdfChunk
	(*End)(nil),       // 4: ocr.End
	(*Ping)(nil),      // 5: ocr.Ping
	(*Ready)(nil),     // 6: ocr.Ready
	(*Pong)(nil),      // 7: ocr.Pong
	(*Progress)(nil),  // 8: ocr.Progress
	(*Result)(nil),    // 9: ocr.Result
	(*Error)(nil),     // 10: ocr.Error
}
var file_ocr_proto_depIdxs = []int32{
	2,  // 0: ocr.ClientMsg.start:type_name -> ocr.Start
	3,  // 1: ocr.ClientMsg.chunk:type_name -> ocr.PdfChunk
	4,  // 2: ocr.ClientMsg.end:type_name -> ocr.End
	5,  // 3: ocr.ClientMsg.ping:type_name -> ocr.Ping
	6,  // 4: ocr.ServerMsg.ready:type_name -> ocr.Ready
	7,  // 5: ocr.ServerMsg.pong:type_name -> ocr.Pong
	8,  // 6: ocr.ServerMsg.progress:type_name -> ocr.Progress
	9,  // 7: ocr.ServerMsg.result:type_name -> ocr.Result
	10, // 8: ocr.ServerMsg.error:type_name -> ocr.Error
	0,  // 9: ocr.OcrService.ExtractTextBidi:input_type -> ocr.ClientMsg
	1,  // 10: ocr.OcrService.ExtractTextBidi:output_type -> ocr.ServerMsg
...
func file_ocr_proto_init() {
	...
	file_ocr_proto_msgTypes[0].OneofWrappers = []any{
		(*ClientMsg_Start)(nil),
		(*ClientMsg_Chunk)(nil),
		(*ClientMsg_End)(nil),
		(*ClientMsg_Ping)(nil),
	}
	file_ocr_proto_msgTypes[1].OneofWrappers = []any{
		(*ServerMsg_Ready)(nil),
		(*ServerMsg_Pong)(nil),
